...
from EmotionalCities.Streams.accelerometerStream    import AccelerometerStream
from EmotionalCities.Streams.empaticaStream         import EmpaticaStream
from EmotionalCities.Streams.ubxStream              import UbxStream
from EmotionalCities.Streams.microphoneStream       import MicrophoneStream

def build_schema(root = None, autoload = False):
    streams = DotMap()
    # BioData streams
